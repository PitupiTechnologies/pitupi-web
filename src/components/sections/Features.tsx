      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-[120px] py-[120px] flex flex-col items-center">
        ...
        <div className="flex flex-col gap-8 w-full max-w-[920px]">
          ...
          <RevealOnScroll direction="up" delay={0}>
            <div className="bg-pitupu-purple-50 rounded-[22px] p-4 md:px-8 py-8 flex flex-col lg:flex-row gap-8 items-stretch min-h-[300px]">
              ...
              <div className="flex-[1.5] w-full rounded-2xl flex items-center justify-center min-h-[200px] overflow-hidden">
                <img
                  src="/images/features/exchange.png"
                  alt="Crypto Exchange"
                  className="w-full"
                />
              </div>
                  ...
                  {[
                    {
                      ...
                      shadow: "shadow-[0_26px_52px_0px_rgba(0,0,0,0.18)]",
                      rotate: "",
                      width: "w-[208px]",
                    },
                    {
                      ...
                      shadow: "shadow-[0_25px_50px_0px_rgba(0,0,0,0.18)]",
                      rotate: "",
                      width: "w-[234px]",
                    },
                    {
                    ...
                    >
                      ...
                      >
                        ...
                        <span className={`font-semibold text-sm ${card.text}`}>
                          $0.0
                        </span>
                      </div>
                    </RevealOnScroll>
          ...
          <RevealOnScroll direction="up" delay={0.15}>
            <div className="bg-pitupu-purple-50 rounded-[22px] p-4 md:px-8 py-8 flex flex-col lg:flex-row gap-8 md:gap-32 items-stretch min-h-[300px]">
              <div className="flex-1 flex flex-col gap-4 justify-center max-w-[296px]">
                <h3 className="text-[28px] font-semibold text-violet-500 tracking-[-0.02em] leading-[1.2]">
                  Automated Gift Card Exchange
                </h3>
                <p className="text-lg font-medium text-violet-300 leading-[1.45]">
                  Buy | Sell your favourites giftcards seamlessly. Every
                  giftcard you sell to us is reviewed by a real person to ensure
                  your asset safety.
                </p>
              </div>
              <div className="w-full md:w-[318px]! relative rounded-2xl flex items-center justify-center overflow-hidden">
                <img
                  src="/images/features/giftcard.png"
